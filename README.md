...
Pour lancer l'application en background (pas de fenêtres supplémentaires) vous pouvez lancer un terminal **Git Bash** avec **les droits administrateurs** et tapez la commande `pm2 resurrect`.
